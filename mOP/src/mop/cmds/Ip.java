			...
			if (args[0].equalsIgnoreCase("enable")) {
				...
				if (IPFilter.getInstance().getConfig().contains("filter." + args[1]) == true) {
					...
					sender.sendMessage(ChatColor.translateAlternateColorCodes('&',
							"&8&l» &aPlayer " + args[1] + " ip filter has been &benabled!"));

				} else
					sender.sendMessage(ChatColor.translateAlternateColorCodes('&',
							"&8&l» &cPlayer " + args[1] + " has never joined the server!"));
				...
				if (IPFilter.getInstance().getConfig().contains("filter." + args[1]) == true) {
					...
					sender.sendMessage(ChatColor.translateAlternateColorCodes('&',
							"&8&l» &aPlayer " + args[1] + " ip filter has been &cdisabled!!"));
				...
				if (IPFilter.getInstance().getConfig().contains("filter." + args[1]) == true) {
					...
					sender.sendMessage(ChatColor.translateAlternateColorCodes('&',
							"&8&l» &c Player " + args[1] + " has never joined the server!"));
				...
				if (IPFilter.getInstance().getConfig().contains("filter." + args[1]) == true) {
					...
					sender.sendMessage(
							ChatColor.translateAlternateColorCodes('&', "&7&l----------------------------------"));
					sender.sendMessage(ChatColor.translateAlternateColorCodes('&',
							"&c Ip logs for " + args[1] + " are the following:"));
				...
				if (IPFilter.getInstance().getConfig().contains("filter." + args[1]) == true) {
					...
					if (IPFilter.getInstance().getStatus(args[1]) == false) {
						...
						sender.sendMessage(ChatColor.translateAlternateColorCodes('&',
								"&8&l» &bIP Filter for &e" + args[1] + " &bis currently: &cDisabed"));

					} else
						sender.sendMessage(ChatColor.translateAlternateColorCodes('&',
								"&8&l» &bIP Filter for &e" + args[1] + " &bis currently: &aEnabled"));
				} else
					sender.sendMessage(ChatColor.translateAlternateColorCodes('&',
							"&8&l» &c Player " + args[1] + " has never joined the server!"));
			} else {
		...
		if (args.length == 3) {
			if (args[0].equalsIgnoreCase("setip")) {
				...
				if (IPFilter.getInstance().getConfig().contains("filter." + args[1]) == true) {
					...
					sender.sendMessage(
							ChatColor.translateAlternateColorCodes('&', "&8&l» &aIP for " + args[1] + " updated!"));
